...
$(function () {
    ...
    $.ajax({
        ...
        success: function (objResult,textStatus) {
            if (objResult.Result=="1"){
                ...
                var vj = obj.Variety;
                if (vj.indexOf("美食")==-1){
                    $("#busVariety div").eq(0).removeClass("on");
                }
                if (vj.indexOf("门票")==-1){
                    $("#busVariety div").eq(1).removeClass("on");
                }
                if (vj.indexOf("酒店")==-1){
                    $("#busVariety div").eq(2).removeClass("on");
                }
    ...
    $("#busSubmit").click(function () {
       ...
       /* if($("#busLicenseP b")){
            ...
            //licenseP= $("#filePicker>.webuploader-pick").attr("url");
        }
        licenseP = $("#filePicker>.webuploader-pick").css('backgroundImage');
        licenseP.substring(0,58);
